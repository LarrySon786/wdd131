...
let age = document.querySelector('#insurance-age');
let cost = document.querySelector('#expected-cost');
let button = document.querySelector('#insurance-button');
...
let patientPhone = document.querySelector('#patient-phone')
let patientEmail = document.querySelector('#patient-email')

let formsubmissions = getFormSubmissions() || 0;

formSubmission.addEventListener('submit', setFormSubmissions()
)



function setFormSubmissions() {
